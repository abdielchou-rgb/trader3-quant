...
trader3/            # 核心包（10 个 Tool，全部经 IronGate）
  ...
  research/         # 研究层（R1-R8）：experiment/labeling/rigor/sample_weights/
...
tests/              # 651 个测试（649 passed / 2 skipped 基线）；testpaths 已在 pyproject 隔离
```
...
3. **量化输出是候选信号，非投资建议**
4. **测试必须绿** — 当前基线 649 passed / 2 skipped
